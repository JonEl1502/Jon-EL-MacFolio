...
const blogPosts = [
    ...
    },
    {
        ...
        link: "https://www.sanapetsveterinaryclinic.com/services",
    },
    {
        id: 3,
        date: "Aug 15, 2025",
...
const WORK_LOCATION = {
    ...
    children: [
        ...
        // Westlands Paws Clinic Project
        {
            id: 8,
            name: "Westlands Paws Clinic Website",
            icon: "/images/folder.png",
            kind: "folder",
            ...
            children: [
                {
                    ...
                    description: [
                        "Westlands Paws Clinic is a Nairobi veterinary practice on Mpaka Road, Westlands — caring for pets since 2016, with 24/7 emergency cover.",
                        "The homepage leads with the two things an owner actually needs at that moment: a booking button and the emergency line, backed by opening hours and the clinic's location.",
                        "Services live on one page with a sticky 'on this page' index — general checkups, vaccinations, parasite control, dental care, diagnosis & treatment, surgery, emergency care and grooming — each with indicative KSh pricing and a plain account of how the clinic approaches the work.",
                        "Booking is a single form (owner, pet, pet type, phone, preferred date and time, reason for visit) confirmed over WhatsApp, alongside a what-to-expect panel and the emergency number for cases that cannot wait.",
                        "Also covers a product shop, about, team profiles and contact. Built with React and deployed on Vercel; the desktop nav collapses to a mobile drawer with the same content intact.",
                    ],
                },
                {
                    id: 802,
                    name: "westlandspawsclinic.vercel.app",
                    icon: "/images/safari.png",
                    kind: "file",
                    fileType: "url",
                ...
                {
                    id: 805,
                    name: "westlandspaws-3.png",
                    icon: "/images/image.png",
                    kind: "file",
                    fileType: "img",
                    position: "top-72 left-16",
                    imageUrl: "/images/westlandspaws-3.webp",
                },
                {
                    id: 806,
                    name: "westlandspaws-4.png",
                    icon: "/images/image.png",
                    kind: "file",
                    fileType: "img",
                    position: "top-72 right-16",
                    imageUrl: "/images/westlandspaws-4.webp",
                },
            ],
        },
        ...
        // SanaPets Vet Clinic Project
        {
            id: 11,
            name: "SanaPets Vet Clinic Website",
            icon: "/images/folder.png",
            kind: "folder",
            ...
            children: [
                {
                    id: 1101,
                    name: "SanaPets Vet Clinic.txt",
                    icon: "/images/txt.png",
                    kind: "file",
                    fileType: "txt",
                    position: "top-16 right-12",
                    description: [
                        "SanaPets Vet Clinic is a Nairobi veterinary practice offering affordable, professional care for pets across the city and its environs.",
                        "The site puts booking first: a WhatsApp-backed appointment form collects the owner's details alongside the pet's name, type and age, so an enquiry reaches the clinic ready to act on instead of as a bare phone call.",
                        "Every service has its own page — dental check-ups, dental surgery, vaccinations, local and international travel paperwork, deworming, tick and flea control, and pet nutrition advice — each spelling out what the appointment covers and how long it takes.",
                        "A filterable product shop (parasite control, supplements, cat care, identification) adds a cart that turns a selection into a single WhatsApp order, alongside a gallery, blog and contact section.",
                        "Built as a responsive React site: the same content carries from a full desktop nav down to a mobile drawer with the service list nested inside it.",
                    ],
                },
                {
                    id: 1102,
                    name: "sanapetsveterinaryclinic.com",
                    icon: "/images/safari.png",
                    kind: "file",
                    fileType: "url",
                    href: "https://www.sanapetsveterinaryclinic.com/",
                    position: "top-4 left-20",
                },
                {
                    id: 1103,
                    ...
                    fileType: "img",
                    position: "top-44 left-16",
                    imageUrl: "/images/sanapets-1.webp",
                },
                {
                    id: 1104,
                    name: "sanapets-2.png",
                    ...
                    fileType: "img",
                    position: "top-44 right-16",
                    imageUrl: "/images/sanapets-2.webp",
                },
                {
                    id: 1105,
                    name: "sanapets-3.png",
                    ...
                    fileType: "img",
                    position: "top-72 left-16",
                    imageUrl: "/images/sanapets-3.webp",
                },
                {
                    id: 1106,
                    name: "sanapets-4.png",
                    ...
                    fileType: "img",
                    position: "top-72 right-16",
                    imageUrl: "/images/sanapets-4.webp",
                },
                {
                    id: 1107,
                    name: "sanapets-5.png",
                    ...
                    imageUrl: "/images/sanapets-5.webp",
                },
            ],
        },
...
const WORK_LOCATION2 = {
    ...
    children: [
        ...
        {
            id: 11,
            name: "SanaPets Vet Clinic Website Project",
            icon: "/images/folder.png",
            kind: "folder",
            position: "top-72 left-70",
            owner: "SanaPets Vet Clinic",
            appIcon: "/images/sanapets-icon.webp",
            desktop_home: true,
            project_type: "web_app",
            children: [
                {
        ...
        // Booky — library-styled book reading app
        {
            id: 17,
            name: "Booky",
            icon: "/images/folder.png",
            ...
            children: [
                {
                    ...
                    position: "top-12 left-12",
                    description: [
                        "Booky is a library-styled book reading app — your personal library for PDFs, EPUBs and audiobooks, laid out like a real shelf instead of a list.",
                        "Read with your eyes or listen with your headphones: switch between PDF and audio for the same book, with your place synced across both. Plus a Today reading plan, Notes, and Docs.",
                        "your library, your day, your quiet hours.",
                    ],
                },
                {
                    id: 1702,
